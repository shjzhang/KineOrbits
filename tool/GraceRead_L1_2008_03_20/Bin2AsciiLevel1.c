...
<-----------------------------------------------------------------------------*/
  ...
  if (!HeaderOnly)
  {
    sprintf(file_format,"%ld",header.formattype);
...
<-----------------------------------------------------------------------------*/
  ...
  {  
    ...
    {
      fprintf(stderr," FileTypePointer = %ld is not defined or filetype pointer refers to Level1A data!!\n",  
                       header.filetype);  
