...
static char SccsId[] = "$Id: ConstructFileName.c,v 1.2 2004/08/30 21:03:33 wib Exp $";

#define MAXCHAR 1000

void ConstructFileName(char *Satellite , double Time, long VersionNumber,
...
/        long VersionNumber   Version number of file for Date
