...
*  subroutine OMC1
*      
      subroutine OMC1(xrcv,crcv,xtrs,vtrs,ctrs,zwd,
     &                elv,time,iPRN,iobs,P3,L)
c
c=======================================================================
c     ****f* SmartPPP/OMC1.f
c
...
c
         debug = .false.
         if(debug)then
            slat = 0.731772172731938d0
            shgt = 98.75250704595179d0
            elv  = 0.148891678740607d0
            zd   = pi/2 - 0.148891678740607d0
         endif
c        MF
c>2      drou/dtrop
