...
c
      real*8        L3Pre(MAX_SAT_NUM)
      real*8        P3Pre(MAX_SAT_NUM)
c!
      real*8        time1
c
...
c
      real*8        L3New(MAX_SAT_NUM)
      real*8        P3New(MAX_SAT_NUM)
c
c     pppkal
c
      integer       nvar
...
c
            ...
            elseif(observ_model.EQ.2)then
               if(flag.EQ.1)then
                  ...
                  Phi(iPRN+4,iPRN+4) = 1.0
c                 !!! initial for ambiguity bias
                  x0 (iPRN+4)        = L3New(i) - P3New(i) 
               endif
            endif
c
         enddo
...
c
         call ppossub(time1,nsat1,aPRN1,flag1,L3New,P3New,
     &                x0,sig_x0)
c
         P(1,1) = 1.0d+10 !xx
         P(2,2) = 1.0d+10 !yy
...
c
         call compsObsEq2(nsat1,aPRN1,L3New,P3New,flag1,time1,
     &                    nvar,x0,A,W,y)
c        
