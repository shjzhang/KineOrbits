...
c     Antenna Eccentricities     azimuth dependent
     ...
     &                                            MAX_REC_ZEN)
c
c**   receiver antenna type
c
      character*60  ANT_TYP_HPX
c
c     common
c     ******
c
...
c     antex_table = 'share/tables/igs01_0000.atx'
c
...
c
         k = 0
c
         ANT_TYP_HPX = MARKER_NAME
c
         do i=1, NREC_ATX
            if(trim(ANT_TYP_HPX).EQ.trim(ANT_TYP(i)))then
               k = i
            endif
         enddo
c
