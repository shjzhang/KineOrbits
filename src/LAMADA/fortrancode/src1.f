      subroutine SRC1 (n, L, D, a, Z)

c*ver version 1.0, dd. 07-04-95
...
c*rol Computation of the Z-transformation matrix 
...
20       continue
         if (.not. swap  .and.  i. gt. 1) then
            i = i - 1
            if (i .le. i1) call ZTRAN (i, i, n, L, a, Z)
