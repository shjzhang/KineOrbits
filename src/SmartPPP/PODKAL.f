...
c  subroutine podkal
c
      subroutine podkal(rnxvsn,nsat_sys,csat_sys,nobs_typ,cobs_typ)
c
c=======================================================================
c     ****f* SmartPPP/podkal
c
...
c                               Wuhan University.
c     ***
C     $Id: podkal.f,v 1.0 2009/08/25 $
c=======================================================================
c
      implicit none
c
...
c                 Phi(iPRN+4,iPRN+4) = 1.0  ! old version
                  Phi(iPRN+4,iPRN+4) = 0.0  ! Modified on 20100329
c                 state parameter update
                  x0 (iPRN+4)        = L3_new(i) - P3_new(i) 
               endif
            endif
         enddo
c
...
c++      write parameters
c           
         write(201,'(5F14.3)') time_new,(x0(k),k=1,4)
         write(  *,'(5F14.3)') time_new,(x0(k),k=1,4)
c
