...
c       write(*,*) 'SAT2ECF'
c       write(*,*)  SAT2ECF(1,1), SAT2ECF(1,2), SAT2ECF(1,3)
c       write(*,*)  SAT2ECF(2,1), SAT2ECF(2,2), SAT2ECF(2,3)
c       write(*,*)  SAT2ECF(3,1), SAT2ECF(3,2), SAT2ECF(3,3)

c        write(*,*) 'Ant phase center offset'
c        write(*,*)  ANT_PCO(1,1) , ANT_PCO(1,2), ANT_PCO(1,3)
c
         do i=1,3
            ANT_PCO_XYZ(i) = 0.0d0
            do k=1,3
...
c
         write(*,*)'ANTENNA phase center offset'
         write(*,*) ANT_PCO_XYZ(1), ANT_PCO_XYZ(2) ,ANT_PCO_XYZ(3)
c
