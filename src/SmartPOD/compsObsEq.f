c
c  subroutine compsObsEq
c
      subroutine compsObsEq(rnxvsn,
     &                      nsat_sys,csat_sys,
...
c
c=======================================================================
c     ****f* SmartPPP/compsObsEq
c
c   FUNCTION   
c   
c     compose the observation equation for Precise Point Positioning
...
c     ***
c
C     $Id: compsObsEq.f,v 1.0 2009/08/10 $
c=======================================================================
c
      implicit none
c
...
c
c     **********************************************
c     composing observation equation for observables
c     **********************************************
c
      iobs = 0
      iepo = 0
...
c
         call corr_rcv(tmp_time_fore,xrcv)
c
...
c
         ...
         call corr_trs(Time,iPRN,xrcv,crcv,xtrs,vtrs,ctrs)           
c
c**      elvation
c
...
c
         ...
         call coeff(xrcv,xtrs,iobs,iepo,idx_iamb, 
     &              NNZA,NRA,RA,CA,A)
c
...
c
c        write(*,*) 'dimension parameter'
c        write(*,*) 'NNZA=',NNZA , 'NRA=',NRA

c
         call OMC(xrcv,crcv,xtrs,vtrs,ctrs,elv,time,
     &            iPRN,iobs,L3,P3,N3,
     &            NNZL,NRL,RL,CL,L)

c        write(*,*) 'NNZL=',NNZL , 'NRL=',NRL
c
c**      weight matrix
c
         call weight(iobs,iepo,elv,NNZP,NRP,RP,CP,P)

c        write(*,*) 'NNZP=',NNZP , 'NRP=',NRP
c
         enddo
c
      endif
